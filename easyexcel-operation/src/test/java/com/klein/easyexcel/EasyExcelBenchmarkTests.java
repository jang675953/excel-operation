...
public class EasyExcelBenchmarkTests {
    ...
    public void enumConverterWrite() {
    ...
    public void templateWrite() throws IOException {
    ...
    public void annotationMultiRead() {
        final CustomReadListener readListener = new CustomReadListener();
    ...
    public void annotationPageRead() {
    ...
    public static void main(String[] args) throws RunnerException {
        Options options = new OptionsBuilder().include(EasyExcelBenchmarkTests.class.getSimpleName()).build();
